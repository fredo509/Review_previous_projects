...
# 📖 [Review-one-previous-project] <a name="about-project"></a>


**[Review-one-previous-project]** is an exercice to make some review on my previous project passed in microverse Admission
...
Use the command: 
 cd your-folder
gh repo clone fredo509/Review_previous_projects
